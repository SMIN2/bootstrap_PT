(function(e, t, n, r) {
	"use strict";
	var i = [], s = [], o = [], u = 0, a = t.location.hash, f = false, l, c, h = e(
			t).scrollTop(), p = false, d = {
		section : "section",
					...
					if (typeof e.touches !== "undefined") {
						...
						case "touchmove":
							...
							if (m.touches.touchstart.y !== m.touches.touchmove.y) {
								e.preventDefault();
								if (m.options.timeStamp + m.options.timeGap < (new Date)
										.getTime()
										&& m.touches.touchend == false) {
									m.touches.touchend = true;
									if (m.touches.touchstart.y > -1) {
										if (Math.abs(m.touches.touchmove.y
												- m.touches.touchstart.y) > m.options.distance) {
											if (m.touches.touchstart.y < m.touches.touchmove.y) {
												if (u > 0) {
													u--
												}
